...
<button id="chatToggleBtn" onclick="toggleChat()">
  ...
  <script>
    ...
    // 2. Fungsi Kirim Pesan ke Server (AJAX)
    function sendMessage() {
      ...
      if (message !== "") {
        ...
        .then(data => {
            // D. Hapus Loading & Tampilkan Jawaban Asli
