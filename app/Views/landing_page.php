            ...
            <div class="card border-0 shadow-sm h-100 p-3">
               <div class="card-body text-center">
                  ...
                  <p class="card-text small text-muted text-start">
                    1. Memberikan pelayanan kesehatan profesional.<br>
      ...
      <form id="waForm" class="php-email-form">
        ...
        <div class="row">
          <div class="col-md-4 form-group">
            <input type="text" id="inputNama" class="form-control" placeholder="Nama Lengkap Pasien" required>
          </div>
          <div class="col-md-4 form-group mt-3 mt-md-0">
            <input type="number" id="inputNik" class="form-control" placeholder="NIK (KTP/KK)" required>
          </div>
          <div class="col-md-4 form-group mt-3 mt-md-0">
            <input type="tel" id="inputHp" class="form-control" placeholder="Nomor WhatsApp Aktif" required>
          </div>
        </div>

        <div class="row">
          <div class="col-md-6 form-group mt-3">
            <input type="date" id="inputTanggal" class="form-control datepicker" required>
          </div>
          <div class="col-md-6 form-group mt-3">
            <select id="inputPoli" class="form-select" required>
        ...
        <div class="form-group mt-3">
          <textarea id="inputKeluhan" class="form-control" rows="5" placeholder="Tuliskan keluhan atau gejala yang dirasakan..." required></textarea>
        </div>
